...
retina.Create('SingleCompartment','V_bipolar',{'number_current_ports','1.0','number_conductance_ports','1.0','Rm','0.0','tau','0.0','Cm','1.0','E','0.0'})
...
retina.multimeter('temporal','Input','Input',{'x','12','y','12'},'Show','True')
retina.multimeter('temporal','OPL_center','Gauss_OPL_center',{'x','12','y','12'},'Show','True')
retina.multimeter('temporal','OPL_surround','Gauss_OPL_surround',{'x','12','y','12'},'Show','True')
retina.multimeter('temporal','OPL_output','OPL_amplification',{'x','12','y','12'},'Show','True')
retina.multimeter('temporal','V_bipolar','V_bipolar',{'x','12','y','12'},'Show','True')
retina.multimeter('temporal','ON_Bip','ON_Bip',{'x','12','y','12'},'Show','True')
retina.multimeter('temporal','OFF_Bip','OFF_Bip',{'x','12','y','12'},'Show','True')
retina.multimeter('temporal','ON_Bip_rectification','ON_Bip_rectification',{'x','12','y','12'},'Show','True')
retina.multimeter('temporal','OFF_Bip_rectification','OFF_Bip_rectification',{'x','12','y','12'},'Show','True')
